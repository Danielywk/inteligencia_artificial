...
```{r}
library(tidyverse)
# Tidyverse carga automáticamente 8 packetes
# ggplot2, tibble, tidyr, readr, purr, dplyr, stringr y forcats
library(dplyr)
# ggplot2 para crrar visualizaciones y gráficos
# tidyr para la limpieza y ordenamiento de datos: funciona en formato ancho y formato largo
# readr se utiliza para leer archivos
# dplyir ara realizar operaciones y cáculos en R (funciones) manipular
```
...
# Para renombar el nombre de una columna
...
# Para renombrar más de una columna

```{r}
rename(diamonds, carat_new = carat, cut_new = cut)
```
# Para conocer la media de la columna "Carat"
...
# Para realizar un gráfico utilizando la libreria ggplot2, importante siempre añadir la función geom_point() para incluir los puntos
...
# Para agregar color al gráfico
# El gráfico siguiente muestra en el eje X el quilate de los metales y en el eje Y los precios
# Se agrega el argumento color, que asigna un umbral de color en base a la calidad del tipo de corte del metal
...
# La función facet_wrap() crea diferentes gráficos en base al parámetro o argumento de interés, en este caso la calidad del corte
