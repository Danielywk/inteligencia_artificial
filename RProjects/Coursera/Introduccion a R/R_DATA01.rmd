...
```{r}
frutas <- c("Mango","Fresa","Papaya","Durazno","Banana")
```
...
```{r}
df_fruit <- data.frame(frutas, puntaje)
head(df_fruit)
```
...
## Trabajando con Tibbets
```{r}
diamonds_tibble <- as.tibble(diamonds)
diamonds_tibble
```
